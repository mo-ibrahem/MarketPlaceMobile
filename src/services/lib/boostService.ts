...
export const BOOST_PACKAGES: Record<'urgent' | 'featured' | 'turbo', BoostPackage> = {
  urgent: {
    ...
    perks: ['Urgent Sale badge on the listing', 'Placed above standard items', 'Active for 3 days'],
  ...
  featured: {
    ...
    perks: [
      ...
      'Pinned to the top of category search',
  ...
  turbo: {
    ...
    perks: [
      'Top placement on home and search',
      'Banner placement across all categories',
      'Notifies people who saved or searched for it',
      'Active for 14 days',
    ],
